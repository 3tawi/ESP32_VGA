...
void getWifi(String user, String pasw) {
    char ssid[30] = "";
    char pass[30] = "";
    int lenuser = user.length() + 1; 
    int lenpasw = pasw.length() + 1; 
    user.toCharArray(ssid, lenuser);
    pasw.toCharArray(pass, lenpasw);
