...
<tr>
    <table>
         <form action="/" method="POST">
        <div class="data-input">
            <input style="width:80%" type="range" name="Speed0" min="3" max="50" value="14" class="slider" id="mySpeed0" onchange="myFunctionS1()">
...
<tr>
    <table>
         <form action="/" method="POST">
        <div class="data-input">
            <input style="width:80%" type="range" name="Speed1" min="1" max="100" value="1" class="slider" id="mySpeed1" onchange="myFunctionS2()">
...
<tr>
    <table>
        ...
        <div class="data-input">
            ...
            <button style="width:30%" class="button-blue" onclick="myFunctionMg()">Send</button>
        </div>
         </form>
        </table>
</tr>
